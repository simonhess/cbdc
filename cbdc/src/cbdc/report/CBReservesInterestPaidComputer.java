 ...
 *
 */
public class CBReservesInterestPaidComputer extends AbstractMicroComputer implements MicroMultipleVariablesComputer {
...
private int banksId;
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent i:pop.getAgents()){
			...
			if (!bank.isDead()){
				result.put(bank.getAgentId(), (bank.getTotInterestsReserves()));
			}
			else{
