 ...
 *
 */
public class CBBondsInterestReceivedComputer extends AbstractMicroComputer implements MicroMultipleVariablesComputer {
...
private int banksId;
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent i:pop.getAgents()){
			CentralBank bank= (CentralBank) i;
			if (!bank.isDead()){
				result.put(bank.getAgentId(), (bank.getBondInterestsReceived()));
			}
			else{
