 ...
 *
 */
public class BanksBondsInterestReceivedComputer extends AbstractMicroComputer implements MicroMultipleVariablesComputer {
...
private int banksId;
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent i:pop.getAgents()){
			Bank bank= (Bank) i;
			if (!bank.isDead()){
				result.put(bank.getAgentId(), (bank.getBondInterestReceived()));
			}
			else{
