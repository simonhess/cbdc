...
public class GovernmentAntiCyclicalWithInvestmentAndDIFund extends GovernmentAntiCyclical implements LaborDemander, BondSupplier, GoodDemander{
	
	protected double desiredRealCapitalDemand;
	protected ArrayList<Agent> selectedCapitalGoodSuppliers;
	private double demand;
	protected ArrayList<Map.Entry<Bank, Deposit>> DIFund;
...
//			macroSim.getActiveMarket().commit(this, seller, marketID);
	...
	public ArrayList<Map.Entry<Bank, Deposit>> getDIFund() {
		return DIFund;
	}

	public void setDIFund(ArrayList<Map.Entry<Bank, Deposit>> dIFund) {
		DIFund = dIFund;
	}
